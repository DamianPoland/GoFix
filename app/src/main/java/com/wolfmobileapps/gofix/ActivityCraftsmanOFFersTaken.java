...
public class ActivityCraftsmanOFFersTaken extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_craftsman_offers_taken);

        //views
        textViewCraftsmanOFFersTakenNo = findViewById(R.id.textViewCraftsmanOFFersTakenNo);
        listViewCraftsmanOFFersTaken = findViewById(R.id.listViewCraftsmanOFFersTaken);
